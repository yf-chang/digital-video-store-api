...
public class TVModel {
    ...
    public TVModel(String id, String title, String episode, String synopsis, String category, Boolean featured, String small_poster, String large_poster, double rent_price, double purchase_price) {
        this.id = id;
        this.title = title;
